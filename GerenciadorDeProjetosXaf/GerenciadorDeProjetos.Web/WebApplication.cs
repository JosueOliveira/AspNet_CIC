...
namespace GerenciadorDeProjetos.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class GerenciadorDeProjetosAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private GerenciadorDeProjetos.Module.GerenciadorDeProjetosModule module3;
        ...
        private GerenciadorDeProjetos.Module.Web.GerenciadorDeProjetosAspNetModule module4;

        public GerenciadorDeProjetosAspNetApplication() {
            InitializeComponent();
        ...
        private void GerenciadorDeProjetosAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
